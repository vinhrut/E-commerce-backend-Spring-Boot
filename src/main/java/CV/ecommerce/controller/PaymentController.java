...
public class PaymentController {
    ...
    public Object handleVnpayReturn(HttpServletRequest request, jakarta.servlet.http.HttpServletResponse response) throws java.io.IOException {
        ...
        PaymentResponse result = paymentService.handleVnpayReturn(params);
        
        String acceptHeader = request.getHeader("Accept");
        if (acceptHeader != null && acceptHeader.contains("text/html")) {
            response.sendRedirect("http://localhost:5173/vnpay-return?" + request.getQueryString());
            return null;
        }
