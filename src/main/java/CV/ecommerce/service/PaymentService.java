...
public class PaymentService {
    ...
    public PaymentResponse handleVnpayReturn(Map<String, String> params) {
        ...
        boolean isValidSignature = receivedHash != null && receivedHash.equalsIgnoreCase(calculatedHash);
    ...
    private String buildVnpayUrl(Long amount, String txnRef, String clientIp, String orderId) {
        ...
        while (itr.hasNext()) {
            ...
            if ((fieldValue != null) && (fieldValue.length() > 0)) {
                try {
                    // Both hashData and query use URL-encoded values (VNPay requirement)
